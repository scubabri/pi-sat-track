 ...
 * Split: MAIN → dl, SUB → ul (logical). Dual: always the physical link.
 */
...
/**
 * Public entry: rate-limit + collapse concurrent Doppler ticks.
 * Global tick is still 250 ms; this driver only talks CI-V every ≥500 ms
 * after sync, and only when |Δf| ≥ 10 Hz (per band).
 */
