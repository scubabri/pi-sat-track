    ...
    models: [
      {
        ...
        defaultDevice: "/dev/ttyUSB0",
        defaultBaud: 38400,
        hint: "Yaesu ASCII CAT. Split: VFO A = DL, VFO B = UL.",
      },
      {
        id: "ft-847",
        label: "FT-847",
        ...
        defaultDevice: "/dev/ttyUSB0",
        defaultBaud: 9600,
        hint: "Binary CAT 8N2. Uses satellite mode for dual UL/DL Doppler.",
      },
      {
        id: "ft-817",
        ...
        defaultDevice: "/dev/ttyUSB0",
        defaultBaud: 9600,
        hint: "Binary CAT 8N2. Split only for FM+fixed UL; linear = VFO A only. Dual 817s = two serial ports.",
      },
      {
        id: "other",
