...
/**
 * After LOS: always hold AZ at min-elevation LOS.
 * When true (default): if Antenna stays on, 5 minutes before the next AOS
 * preposition to that pass’s min-elevation AOS AZ. Park still homes explicitly.
 */
