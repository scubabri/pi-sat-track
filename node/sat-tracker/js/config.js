...
function sendEndpointsToServer(cfg) {
  ...
  const dl = cfg.radioDl || defaultSide("dl");
  ...
  ws.send(
    JSON.stringify({
      ...
      rigctlUlHost: ul.protocol === "rigctl" || ul.type === "rigctl" ? ulRig.host : "",
      rigctlUlPort: ul.protocol === "rigctl" || ul.type === "rigctl" ? ulRig.port : 0,
      flexUlHost: ulCat.host,
      flexUlPort: ulCat.port,
      flexDlHost: dlCat.host,
      flexDlPort: dlCat.port,
      flexApiHost: api.host || "",
      flexApiPort: api.port || 4992,
      serialDevice: dl.serialDevice,
      serialBaud: dl.serialBaud,
      serialDevice2: ul.serialDevice,
      serialBaud2: ul.serialBaud,
      serialMake: dl.serialMake,
      serialModel: dl.serialModel,
