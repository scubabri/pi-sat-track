...
// Radio 1 = primary (DL / split host). Radio 2 optional (UL when dual-radio).
...
// Radio 2 (optional UL). Empty device → single-radio SPLIT on Radio 1.
...
/**
 * Dual CAT (two radios) when Radio 2 device is set and differs from Radio 1.
 * Otherwise single-radio SPLIT mode on Radio 1.
 */
function isDualCat() {
...
function applyEndpoints(ep) {
  ...
  // Radio 2 (optional UL). Empty string clears dual mode → SPLIT on Radio 1.
